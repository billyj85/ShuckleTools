...
# SAME AS webhook.py but without the brain damaged global args.
...
def send_to_webhook(args, session, message_type, message):
        ...
        try:
            ...
            with wh_lock:
                ...
                if ident is None or key_cache is None:
                    ...
                    send_to_webhook(args, session, whtype, message)
